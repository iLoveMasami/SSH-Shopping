		...
		<div class="span18 last">
			...
			<div class="productImage">
					<a title="" style="outline-style: none; text-decoration: none;" id="zoom" href="http://image/r___________renleipic_01/bigPic1ea8f1c9-8b8e-4262-8ca9-690912434692.jpg" rel="gallery">
						<div class="zoomPad">
							<img style="opacity: 1;" title="" class="medium" src="${pageContext.request.contextPath}/resources/image/<s:property value="model.image"/>">
			...
			<div id="bar" class="bar">
				...
				<div id="introduction" name="introduction" class="introduction">
					...
					<div>
						<img src="${pageContext.request.contextPath}/resources/image/<s:property value="model.image"/>">
					</div>
				</div>
