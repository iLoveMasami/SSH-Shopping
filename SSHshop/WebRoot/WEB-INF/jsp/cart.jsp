			...
			<div class="step step1">
				...
				<table>
					...
					<s:iterator value="#session.cart.cartItems" var="cartItem">
						<tr>
							<td width="60">
								<img src="${pageContext.request.contextPath}/resources/image/<s:property value="#cartItem.product.image"/>">
							</td>
							<td>
								<a target="_blank" href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="#cartItem.product.pid"/>"> 
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart_removeCart.action?pid=<s:property value="#cartItem.product.pid"/>" class="delete">
								删除</a>
							</td>
						</tr>
						</s:iterator>
